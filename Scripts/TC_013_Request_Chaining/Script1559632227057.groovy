...
Res_Get_Customer_Error = WS.sendRequest(findTestObject('GetCustomerDynamicID', [('customerID') : fetched_CID, ('endpoint') : GlobalVariable.endpoint]))

WS.verifyResponseStatusCode(Res_Get_Customer_Error, 404)


def jsonS2 = new JsonSlurper()

def jsonResponse2 = jsonS2.parseText(Res_Get_Customer_Error.getResponseText())

println("Error code is " + jsonResponse2.errorCode)
println("Error message is " +jsonResponse2.errorMessage)
println("System error is " +jsonResponse2.systemError)
